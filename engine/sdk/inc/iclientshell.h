...
/*!
\param  c       Printable character generated by the platform text input path.

Called each update loop when text input produces a character. Use this for UI
edit fields instead of deriving text from key codes.
