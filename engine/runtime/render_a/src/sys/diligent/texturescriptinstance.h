 ...
 *
 * This header defines the Texturescriptinstance portion of the Diligent renderer.
...
struct TextureScriptStageData
{
	LTMatrix transform;
	uint32 flags = 0;
	ITextureScriptEvaluator::EInputType input_type = ITextureScriptEvaluator::INPUT_UV;
	bool valid = false;
};
