...
#define __COUNTER_H__
	...
	// Start a counter.
	inline void cnt_StartCounter(Counter & /*pCounter*/) {}

	// Returns the number of ticks since you called StartCounter.
	inline unsigned long cnt_EndCounter(Counter & /*pCounter*/) { return 0; }
	...
	// Start a counter.
	inline void cnt_StartCounter(Counter &pCounter) { cnt_StartCounterFinal(reinterpret_cast<CounterFinal&>(pCounter)); }

	// Returns the number of ticks since you called StartCounter.
	inline unsigned long cnt_EndCounter(Counter &pCounter) { return cnt_EndCounterFinal(reinterpret_cast<CounterFinal&>(pCounter)); }
